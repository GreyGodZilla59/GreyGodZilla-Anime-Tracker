...
if exist "C:\Scripts\Releases\Copy-To-FinalDistro.bat" (
  copy /Y "%APK%" "%TEMP%\Grey GodZilla Anime Tracker v1.4.1-android.apk" >nul
  call "C:\Scripts\Releases\Copy-To-FinalDistro.bat" "%TEMP%\Grey GodZilla Anime Tracker v1.4.1-android.apk"
)
